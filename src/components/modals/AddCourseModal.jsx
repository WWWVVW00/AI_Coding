          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select 
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
                <option value="Spring">{t('addCourseModal.spring')}</option>
                <option value="Summer">{t('addCourseModal.summer')}</option>
                <option value="Fall">{t('addCourseModal.fall')}</option>
                <option value="Winter">{t('addCourseModal.winter')}</option>
              </select>
            </div>
          </div>
          <div>
